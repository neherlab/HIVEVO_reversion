...
if __name__ == '__main__':
    fig1, fig2, fig3, fig4 = False, True, False, False
    savefig = False
    ...
    if fig2:
        ...
        text = [("8%", [4.1, -0.002]), ("92%", [4.1, 0.054]),
                ("4%", [4.1, 0.048]), ("2%", [4.1, 0.111]), ("11%", [4.1, 0.023])]
        # text = {"env": [],
        #         "pol": [("test", [-0.002, 4.5]), ("test2", [0.061, 0.041])],
        #         "gag": []}
        ...
        for ii, key in enumerate(["all", "consensus", "non_consensus"]):
            ...
            axs[0].plot(time, data, lines[ii], color=colors[ii], label=f"{key}")
